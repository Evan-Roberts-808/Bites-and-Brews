...
function RecipesDetails() {
  ...
  return (
    <Container>
      ...
      <h2>{recipeDetails.name}</h2> <FontAwesomeIcon icon={faThumbsUp} onClick={handleLikeClick} style={{"--fa-primary-color": "#ff3b3f", "--fa-secondary-color": "#c52b30",}}/><p>{likeCount}</p>
